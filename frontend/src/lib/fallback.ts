  ...
  federalHighlights: [
    {
      ...
      headline: "Cobertura en vivo en desarrollo",
      section: "Pulso Federal",
      slug: null,
      isExternal: false,
      imageUrl: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80",
      excerpt: "Mesa politica activa con foco territorial y agenda en construccion.",
      sourceUrl: null,
      publishedAt: now,
    },
    {
      ...
      excerpt: "Seguimiento regional con mirada economica y electoral.",
      sourceUrl: null,
      publishedAt: now,
    },
    {
      ...
      excerpt: "Actualizacion federal para la agenda productiva y legislativa.",
      sourceUrl: null,
      publishedAt: now,
    },
    {
      ...
      excerpt: "Portada federal preparada para provincias, municipios y radar local.",
      sourceUrl: null,
      publishedAt: now,
    },
  ],
